...
echo "     kubectl delete pods -n batchivo -l app=backend"
echo "     kubectl get pods -n batchivo -w"
echo ""
echo "  2. Check pod events for successful image pulls:"
echo "     kubectl describe pod -n batchivo <pod-name>"
echo ""
echo "  3. Monitor backend logs for migration execution:"
echo "     kubectl logs -f -n batchivo -l app=backend -c run-migrations"
echo ""
